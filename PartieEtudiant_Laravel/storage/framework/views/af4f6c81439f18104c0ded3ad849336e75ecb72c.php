...
<div class="wrap-contact100">
  <form class="contact100-form validate-form" method="POST" action="<?php echo e(route('typedemande')); ?>">
      <?php echo csrf_field(); ?>
      <div class="drapeau1">
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Genilogiciel/resources/views/choix.blade.php ENDPATH**/ ?>